        ...
        onTap: () {
          if (title == 'Employees') {
            ref
                ...
                .setHRManagementContent(const EmployeeListScreen());
          } else if (title == 'Attendance Register') {
            ref
                .read(navigationProvider.notifier)
                .setHRManagementContent(const AttendanceRegisterScreen());
          } else if (title == 'Attendance Logs') {
            ref
                .read(navigationProvider.notifier)
                .setHRManagementContent(const AttendanceListScreen());
          } else if (title == 'Overtime Management') {
            ref
                .read(navigationProvider.notifier)
                .setHRManagementContent(const OTManagementScreen());
          } else if (title == 'Office Attendance') {
            ref
                .read(navigationProvider.notifier)
                .setHRManagementContent(const FaceAttendanceScreen());
          } else if (title == 'Designation') {
            ref
                .read(navigationProvider.notifier)
                .setHRManagementContent(const DesignationListScreen());
          } else if (title == 'Department') {
            ref
                .read(navigationProvider.notifier)
                .setHRManagementContent(const DepartmentListScreen());
          } else if (title == 'Basic Pay') {
            ref
                .read(navigationProvider.notifier)
                .setHRManagementContent(const BasicPayScreen());
          } else if (title == 'Salary') {
            ref
                .read(navigationProvider.notifier)
                .setHRManagementContent(const SalaryScreen());
          }
        },
      ),
    );
